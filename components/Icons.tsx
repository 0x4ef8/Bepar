...
export const CheckBadgeIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" {...props}>
        <path fillRule="evenodd" d="M8.603 3.799A4.49 4.49 0 0 1 12 2.25c1.357 0 2.573.6 3.397 1.549a4.49 4.49 0 0 1 3.498 1.548c.956.956 1.548 2.24 1.548 3.599s-.592 2.643-1.548 3.599a4.49 4.49 0 0 1-1.548 3.498 4.49 4.49 0 0 1-1.549 3.397c-.956.956-2.24 1.548-3.599 1.548s-2.643-.592-3.599-1.548a4.49 4.49 0 0 1-3.498-1.548 4.49 4.49 0 0 1-1.548-3.498 4.49 4.49 0 0 1-1.549-3.397c-.015-.262-.023-.526-.023-.792s.008-.53.023-.792a4.49 4.49 0 0 1 1.549-3.397 4.49 4.49 0 0 1 1.548-3.498ZM11.25 15.75 16.5 9l-1.06-1.06-4.19 4.19-2.12-2.12-1.06 1.06 3.18 3.18Z" clipRule="evenodd" />
    </svg>
);
...
export const ChatBubbleLeftRightIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72-3.72a1.054 1.054 0 0 0-1.054 1.054v.266a2.11 2.11 0 0 1-2.11 2.11H6.75a2.11 2.11 0 0 1-2.11-2.11V6.75a2.11 2.11 0 0 1 2.11-2.11H16.5a1.054 1.054 0 0 0 1.054-1.054v-.266a2.11 2.11 0 0 1 2.11-2.11h.118a2.11 2.11 0 0 1 1.652 3.203l-3.255 3.255A1.054 1.054 0 0 0 16.5 8.511v.211a1.054 1.054 0 0 0 1.054 1.054h.211a1.054 1.054 0 0 0 .848-.485l3.255-3.255Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 3.75v14.25A2.25 2.25 0 0 0 5.25 20.25h10.5a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 15.75 4.5h-4.5a2.25 2.25 0 0 1-2.25-2.25V.75A.75.75 0 0 0 8.25 0H5.25A2.25 2.25 0 0 0 3 2.25Z" />
  </svg>
);
...
export const BriefcaseIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.075a2.25 2.25 0 0 1-2.25 2.25h-10.5a2.25 2.25 0 0 1-2.25-2.25V14.15M16.5 8.25V6a2.25 2.25 0 0 0-2.25-2.25h-4.5A2.25 2.25 0 0 0 7.5 6v2.25m9 0H7.5" />
  </svg>
);
...
export const GlobeAltIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c.331 0 .658-.025.974-.069M12 21a8.966 8.966 0 0 0-5.417-1.649M12 3c.331 0 .658.025.974.069M12 3a8.966 8.966 0 0 1 5.417 1.649M12 3v18M12 3a8.966 8.966 0 0 0-5.417 1.649m10.834 0a8.966 8.966 0 0 1-5.417-1.649M3.284 14.251a8.966 8.966 0 0 1 0-4.502m17.432 4.502a8.966 8.966 0 0 0 0-4.502" />
  </svg>
);
